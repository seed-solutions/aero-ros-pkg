...
# Callback of the ROS subscriber.
    def callback(self, data):
        ...
        self.left_cam_info.header = data.header
        self.right_cam_info.header = data.header
        publisher.publish()
    ...
    def __init__(self, camera_name):
        ...
        right_file_name = rospy.get_param(
            '~right_file_name',
            rospack.get_path('ps4eye')+'/camera_info/right.yaml')
        ...
        self.left_image_pub = rospy.Publisher(left_topic,Image)
        self.right_pub = rospy.Publisher(right_topic,CameraInfo)
        self.right_image_pub = rospy.Publisher(right_topic,Image)
