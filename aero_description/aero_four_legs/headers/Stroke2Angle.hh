  ...
  namespace common
  {
	...
	* (right_wrist_roll_stroke >= 0 ? 1 : -1);
	...
	-deg2Rad * (scale * can_r_hand * 8.475 + 50.0);
      ...
      meta = 0;
      meta =
	-deg2Rad * scale * can_front_l_crotch_y;
      meta =
	deg2Rad * CrotchPitchInvTable(scale * can_front_l_crotch_p);
      meta =
	deg2Rad * KneePitchInvTable(scale * can_front_l_knee_p);
      meta =
	-deg2Rad * scale * can_rear_l_crotch_y;
      meta =
	deg2Rad * CrotchPitchInvTable(scale * can_rear_l_crotch_p);
      meta =
	deg2Rad * KneePitchInvTable(scale * can_rear_l_knee_p);
      meta =
	-deg2Rad * scale * can_front_r_crotch_y;
      meta =
	deg2Rad * CrotchPitchInvTable(scale * can_front_r_crotch_p);
      meta =
	deg2Rad * KneePitchInvTable(scale * can_front_r_knee_p);
      meta =
	-deg2Rad * scale * can_rear_r_crotch_y;
      meta =
	deg2Rad * CrotchPitchInvTable(scale * can_rear_r_crotch_p);
      meta =
	deg2Rad * KneePitchInvTable(scale * can_rear_r_knee_p);
    };
