/*
  @define ShoulderPitchInvTable from nagatsuka_arm_shoulder_p offset 0
  @define ElbowPitchInvTable from nagatsuka_arm_elbow_p offset 0
...
namespace aero
{
  namespace common
  {
	...
	deg2Rad * ShoulderPitchInvTable(scale * can_r_shoulder_p);
      meta =
	deg2Rad * ElbowPitchInvTable(scale * can_r_elbow_p)/2;
      meta = 
	-deg2Rad * ElbowPitchInvTable(scale * can_r_elbow_p)/2;; // r_elbow2_joint
      meta =
