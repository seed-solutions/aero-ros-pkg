...
create_table_func_from_csv() { # joint_name table/real_origin_diff
    ...
    lisp="${lisp}${tab2}${tab2}(let ((integral (ceiling (if (eps= (float (round angle)) angle) (float (round angle)) angle)))\n"
...
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :hand-table (elt av 7))\n"
...
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :hand-table (- (elt av 18)))\n"
...
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :crotch-p-table (elt av 1))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :knee-p-table (elt av 2))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(- (elt av 3))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :crotch-p-table (elt av 4))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :knee-p-table (elt av 5))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(- (elt av 6))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :crotch-p-table (elt av 7))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :knee-p-table (elt av 8))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(- (elt av 9))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :crotch-p-table (elt av 10))\n"
body="${body}${tab2}${tab2}${tab2}${tab2}(send self :knee-p-table (elt av 11))\n"
